% Individual analysis script for the effect of motivation on emotion regulation in a RSVP Task
...
rt                          = log(rt(nTrial)/1000); %log and sec transform
block                       = block(nTrial);
...
if fig
    ...
    % Title of the whole plot
    %sgtitle(['Learning Curve for Pilot n°',num2str(participant_participantID)])
